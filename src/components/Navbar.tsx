        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden sm:flex items-center gap-2">
            <a
              ...
              className="flex items-center gap-1.5 px-3.5 py-2 text-xs font-bold text-emerald-700 bg-emerald-50 hover:bg-emerald-100 rounded-xl border border-emerald-200 transition-all"
            >
              <PhoneCall className="w-3.5 h-3.5 text-emerald-600" />
              <span>0811-715-608</span>
            </a>
          ...
          <div className="flex sm:hidden items-center gap-2">
            {isAdmin && (
              <span className="inline-flex items-center gap-1 px-2 py-1 text-[10px] font-black uppercase tracking-wider text-blue-800 bg-blue-100 rounded-md">
            ...
            <button
              ...
              className="p-2 text-slate-600 hover:text-blue-900 hover:bg-slate-100 rounded-lg"
        ...
        >
          ...
          <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 w-full py-2.5 text-sm font-bold text-white bg-emerald-600 rounded-xl"
            >
              <PhoneCall className="w-4 h-4" />
              <span>WhatsApp: 0811-715-608</span>
            </a>
            {isAdmin ? (
